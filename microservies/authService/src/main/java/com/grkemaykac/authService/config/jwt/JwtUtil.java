package com.grkemaykac.authService.config.jwt;
...
public class JwtUtil {
    ...
    private Long extractTokenGenereateTime(String token)
    {
    ...
    public Boolean validateToken(String token, userEntity userDetails) {
        ...
        return (username.equals(userDetails.getUsername())
                ...
                && extractTokenGenereateTime(token) > userDetails.getUpdatedTime());
    }
}